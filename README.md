...
Validación en Tiempo Real: Análisis instantáneo de la demanda actual frente a la histórica.
...
Frontend: Una interfaz reactiva de alto impacto construida en Vue.js, diseñada bajo principios de Glassmorphism para una visualización de datos clara y profesional.

Fuentes de Datos: * Serper API: Acceso directo a los índices de Google Trends.

Gemini AI: Motor de interpretación estratégica.
...
Gráfico de Interés Histórico: Representación del Índice de Interés Relativo (0-100) de los últimos 6 meses, permitiendo identificar el "Momentum" del mercado.
...
Node.js & NPM (para el frontend en Vue).

Instancia de MySQL.

Configuración del Backend
Navegar a la carpeta del servidor: cd BF-Analyzer-API

Configurar las variables de entorno en appsettings.json (API Keys de Serper y Gemini).

Ejecutar: dotnet run

Configuración del Frontend
Navegar a la carpeta del cliente: cd BF-Analyzer-Web
...
Detección de nichos de inversión locales.

Reportes de competencia B2B.
